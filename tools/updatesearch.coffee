...
func_blog.getAll 1,5000,null,(error,blogs)->
  queuedo blogs,(article,next,context)->
    search.add {type:"blog","pid":article.uuid,"title":article.title,"html":article.content.replace(/<[^>]*>/g,""),"uuid":article.uuid,"id": article.id},()->
      next.call(context)
  ,()->
