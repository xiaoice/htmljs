...
var default_alipay_config = {
	...
	,host:'http://www.html-js.com/' //域名
	,cacert:'cacert.pem'//ca证书路径地址，用于curl中ssl校验 请保证cacert.pem文件在当前文件夹目录中
	,transport:'http' //访问模式,根据自己的服务器是否支持ssl访问，若支持请选择https；若不支持请选择http
	,input_charset:'utf-8'//字符编码格式 目前支持 gbk 或 utf-8
	,sign_type:"MD5"//签名方式 不需修改
	,create_direct_pay_by_user_return_url : 'http://www.html-js.com/alipay/create_direct_pay_by_user/return_url'
	,create_direct_pay_by_user_notify_url: 'http://www.html-js.com/alipay/create_direct_pay_by_user/notify_url'
	,refund_fastpay_by_platform_pwd_notify_url : 'http://www.html-js.com/alipay/refund_fastpay_by_platform_pwd/notify_url'
	,create_partner_trade_by_buyer_notify_url: 'http://www.html-js.com/aplipay/create_partner_trade_by_buyer/notify_url'
	,create_partner_trade_by_buyer_return_url: 'http://www.html-js.com/aplipay/create_partner_trade_by_buyer/return_url'
