...
$(document.body).append("<style>.hihihi{background:#ddd !important;}"
  +".hihihi-wrapper{position:fixed;right:0;top:0;width:300px;padding:10px;background:#ddd;}"
  +".hihihi-title{}"
  +".hihihi-content{max-height:400px;overflow:auto;}"
  +"</style>").append(html)
